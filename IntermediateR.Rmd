...
__Remark:__ It is often useful, when writing a function or a loop to add a ``print()`` output. This allows for you to verify that the process is executing correctly and can save you some headaches!
